...
if (defined('CI_VERSION') && substr(CI_VERSION, 0, 1) != '2') {
    ...
    $db['default'] = array(
        'dsn'          => '',
        'hostname'     => 'cibonefire.db.10599987.hostedresource.com',
        'username'     => 'cibonefire',
        'password'     => 'Admin@123',
        'database'     => 'cibonefire',
        'dbdriver'     => 'mysqli',
    ...
    $db['default']['hostname'] = 'cibonefire.db.10599987.hostedresource.com';
    $db['default']['username'] = 'cibonefire';
    $db['default']['password'] = 'Admin@123';
    $db['default']['database'] = 'cibonefire';
    $db['default']['port']     = '';
